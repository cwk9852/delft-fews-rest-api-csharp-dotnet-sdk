...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Location : IEquatable<Location>, IValidatableObject
    {
        ...
        public Location(string locationId = default(string), string locationName = default(string), string description = default(string), string shortName = default(string), string startDateTime = default(string), string endDateTime = default(string), string lat = default(string), string lon = default(string), string x = default(string), string y = default(string), string z = default(string), List<Attributes> attributes = default(List<Attributes>), List<LocationRelation> relations = default(List<LocationRelation>), string parentLocationId = default(string))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null)
            {
                throw new ArgumentNullException("locationId is a required property for Location and cannot be null");
            }
        ...
        public List<LocationRelation> Relations { get; set; }
