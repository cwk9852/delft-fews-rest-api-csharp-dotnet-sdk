...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Filter : IEquatable<Filter>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Filter" /> class.
        /// </summary>
        /// <param name="id">the id of the Filter (required).</param>
        /// <param name="name">The filter name (required).</param>
        public Filter(string id = default(string), string name = default(string))
        {
