...
namespace Org.OpenAPITools.Model
{
    ...
    /// Category
    /// </summary>
    [DataContract(Name = "Product_category")]
    public partial class ProductCategory : IEquatable<ProductCategory>, IValidatableObject
    {
        ...
        public ProductCategory(string id = default(string), string name = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ProductCategory and cannot be null");
            }
            this.Id = id;
