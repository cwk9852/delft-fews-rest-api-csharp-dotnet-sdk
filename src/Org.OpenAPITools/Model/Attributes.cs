...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Attributes : IEquatable<Attributes>, IValidatableObject
    {
        ...
        public Attributes(string name = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), string id = default(string), string startDateTime = default(string), string endDateTime = default(string), string value = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Attributes and cannot be null");
            }
            this.Name = name;
